...
<section>
    ...
    <div class="left-side sticky-left-side">
        ...
        <div class="left-side-inner">
            ...
            <!--sidebar nav start-->
            <ul class="nav nav-pills nav-stacked custom-nav">
                <li class="active"><a href="index.html"><i class="fa fa-home"></i> <span>模块管理</span></a></li>
                  <li class="menu-list"><a href=""><i class="fa fa-laptop"></i> <span>管理员模块</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="">管理员列表</a></li>
                        <li><a href="">添加管理员</a></li>
                    </ul>
                </li>
                <li class="menu-list"><a href=""><i class="fa fa-laptop"></i> <span>会员模块</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="">会员列表</a></li>
                        <li><a href="">添加会员</a></li>
                    </ul>
                ...
                <ul class="notification-menu">
                    ...
                    <li>
                        ...
                        <ul class="dropdown-menu dropdown-menu-usermenu pull-right">
                            <li><a href="#"><i class="fa fa-user"></i>管理员</a></li>
...
<script src="http://cdnjs.cloudflare.com/ajax/libs/underscore./admin/js/1.5.2/underscore-min.js"></script>
